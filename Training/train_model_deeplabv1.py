...
def train(model, num_epoch, dataset_train, train_loader, train_size, val_loader, val_size, optimizer):
    count       = 0
    save_path   = "C:/Users/Dell/Desktop/prediction-deeplabv3"
    ...
    for epoch in range(num_epoch):
        ...
        for batch_idx, (inputs, labels) in enumerate(train_loader):
            ...
            print('Loss: {:.6f}'.format(loss.item()/len(inputs)),"Test Accuracy: {:.3f}".format(accuracy/len(val_loader)))
...
################################test#################################
        if epoch % check_every == 0 and epoch !=0:
            ...
            for batch_idx, (inputs, labels) in enumerate(val_loader):
                ...
                print("validation Accuracy: {:.3f}".format(accuracy1/len(val_loader)))
